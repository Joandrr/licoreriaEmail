...
import Backend.Servicio.CambiarEstado.GeneralCambiarEstadoUtils;
...
public class ServicioEstadoDTO {
    ...
    public ServicioEstadoDTO(){}
    public ServicioEstadoDTO(Long id,String estado){
        this.id = id;
        this.estado = estado;
    }
    public static Resultado<ServicioEstadoDTO> crearServicioEstadoFromSubject(String subject){
        ...
        if(!GeneralCambiarEstadoUtils.esEstadoServicioValido(estado)){
        ...
        return Resultado.ok(new ServicioEstadoDTO(idDto,estado));
    }
}
