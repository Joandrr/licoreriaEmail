...
public class UpdatePagoSQLQuery {
    private static final String UPDATE_DETALLE_PAGO = """
        UPDATE public.detalle_pagos
        SET monto = ?, tipo_pago_id = ?
        WHERE id = ?
        """;
...
//    public String executeUpdatePago(PGSQLClient pgsqlClient, UpdatePagoDTO dto){
...
//            }
//            VentaSimpleDTO ventaSimpleDTO = GeneralPagoSQLUtils.findVentaConPagos(connection,dto.id);
//            if (ventaSimpleDTO == null) {
//                return "Error.. la venta no existe";
//            }
//            //calcular el total actual de pagos
//            float nuevoTotal = GeneralPagoSQLUtils.calcularMontoTotalDePago(ventaSimpleDTO) + dto.monto;
